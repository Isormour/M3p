# Ramki i ozdoby UI — DwarvenFrames v1
...
Pliki znajdują się w Assets/_Project/Graphics/UI/DwarvenFrames_v1.
...
Pełne prompty i ścieżki źródłowe: output/ui-dwarven-frames/manifest.json.
